...
public class TrabajaPEGUI extends JFrame implements ActionListener
{
...
private CompanyAD company = new CompanyAD();
    ...
    public TrabajaPEGUI()
    {
        ...
        panel1.add(new JLabel("ASIGNACION DE PROYECTOS"));
        panel1.add(new JLabel());
        panel1.add(new JLabel("Numero de proyecto: "));
...
//            System.exit(0);
    ...
    {
        TrabajaPEGUI localidad = new TrabajaPEGUI();
    }
}
